...
Osoba, koja mo\v ze biti zaposlena ili nezaposlena, dolazi u Nacionalnu slu\v zbu za zapo\v sljavanje kako bi podnela zahtev za procenu radne sposobnosti nakon \v cega se formira komisija i vr\v si sam \v cin procene.
...
\begin{enumerate}
	...
	\item \v SS \v salje S-i na e-mail adresu listu potrebnih dokumenata koje treba da donese i primer uplatnice radi pla\' canja tro\v skova procene radne sposobnosti.
...
\noindent U\v cesnici: Stranka(u daljem tekstu S), \v Salterski slu\v zbenik (u daljem tekstu \v SS)
\\
\\ Preduslovi: \v SS je ulogovan na sistem.
\\
\\ Postuslovi: Dokumenta su prosle\dj ena Savetniku za zapo\v sljavanje osoba sa invaliditetom.
\\
\\ Glavni tok:
\begin{enumerate}
	\item S prilazi automatu i bira opciju ''Zahtevi i molbe''.
	...
	\item \v SS vra\' ca li\v cnu kartu.
...
\begin{description}
	...
	Ukoliko u koraku 10 Glavnog toka \v SS ustanovi da S nije doneo sva potrebna dokumenta ili dokaz o uplati, \v SS mu govori koja dokumenta mu fale. Slu\v caj upotrebe se ovde zavr\v sava.
\end{description}
...
\noindent U\v cesnici: Savetnik za zapo\v sljavanje osoba sa invaliditetom (u daljem tekstu SZ)
\\
...
\noindent U\v cesnici: Komisija (u daljem tekstu K), Stranka (u daljem tekstu S)
\\
...
\noindent U\v cesnici: Pravno lice (u daljem tekstu PL), Direkotor (u daljem tekstu D)
\\
...
\subsubsection{Slu\v caj upotrebe: Slanje re\v senja o proceni radne sposobnosti stranki}
\label{su: slanje resenja o radnoj sposobnosti}

\noindent U\v cesnici: Referent prijema i ekspedicije po\v ste (RPEPu daljem tekstu ).
\\
\\ Preduslovi: Pravno lice je prosledio overeno re\v senje u pisarnicu.
\\
