...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		\begin{enumerate}
			...
			\item Prelazi se na korak ?.
		\end{enumerate}
		\item NL bira da ne ugovori razgovor za posao, pa se prelazi na korak ?.
	\end{enumerate}
	\item Koraci ? i ? se ponavljaju sve dok ima poslova u ponudi.
	\item SZ vra\' ca evidentacioni karton NL.
\end{enumerate}
